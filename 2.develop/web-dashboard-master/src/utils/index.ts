...
//  ["https://zenkoo.s3.ap-southeast-1.amazonaws.com/avatar/2407/_EoLhgNWj"]
// 输出: /avatar/2407/_EoLhgNWj
export function getPathFromUrlArray(urlArray: string[]): string | null {
  if (!urlArray.length || urlArray?.length === 0) {
    return null
  }
