...
async function openLevelConfig() {
  ...
  const formValue = ref({
    ...
    sub: {
      ...
      recharge_points: data.xp_conf.recharge.exp_points,
      diamonds_amount: data.xp_conf.diamonds.amount,
      diamonds_points: data.xp_conf.diamonds.exp_points,
    },
  })
      ...
      return {
        ...
        xp_conf: {
          recharge: {
            ...
            exp_points: data.sub.recharge_points
          },
          diamonds: {
            amount: data.sub.diamonds_amount,
            exp_points: data.sub.diamonds_points
          }
        },
      }
    },
