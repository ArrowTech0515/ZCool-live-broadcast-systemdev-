<template>
  <a-card style="margin-bottom: 1%;">
    <template #title>
      <div style="display: flex; align-items: center; white-space: nowrap;">
        ...
        <div style="flex-grow: 1; text-align: center;">
          <span style="font-size: 20px; font-weight: bold;">迁移应用</span>
        </div>
      </div>
    </template>
    ...
    <FormSearch
      ...
      @emit_migrate="() => customTableRef.onMigrateApplication()"
    />
  </a-card>
  <a-card style="margin-bottom: 1%;">
    <div style="flex-grow: 1; text-align: left; margin-bottom: 1%">
      <span style="font-size: 20px; font-weight: bold;">迁移记录</span>
    </div>
    <CustomTable
      ref="customTableRef"
