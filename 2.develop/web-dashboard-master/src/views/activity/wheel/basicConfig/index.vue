...
const dataSource = ref([
  { key: '1', sorting: '1', name: '1000元挡位', withdrawal: '1000', validityPeriod: '3天', nPromoters: '2000', nSubordinate: '100', totalSubordinate: '50000', nDevicelimit: '1', operate: '编辑' },
  { key: '2', sorting: '2', name: '3000元挡位', withdrawal: '2000', validityPeriod: '7天', nPromoters: '4000', nSubordinate: '200', totalSubordinate: '100000', nDevicelimit: '1', operate: '编辑' },
  { key: '3', sorting: '3', name: '5000元挡位', withdrawal: '5000', validityPeriod: '15天', nPromoters: '10000', nSubordinate: '500', totalSubordinate: '150000', nDevicelimit: '1', operate: '编辑' },
]);
...
const handleSave = (updatedData) => {
  if (operationType.value === '新增') {
    dataSource.value.push({ ...updatedData, key: String(dataSource.value.length + 1) }); // Generate a new key
