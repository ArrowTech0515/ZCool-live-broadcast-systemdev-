<template>
  ...
  <span style="font-size: 14px; font-weight: bold; color: red; margin-bottom: 15px;">
    请确认已转账至主播提供的虚拟币账户后再进行确认操作，以免主播投诉
  </span>
    <!-- Conditionally render the CustomSpin component if '钻石奖励' is selected -->
    <a-form-item  label="提现虚拟币" style="margin-top: 15px;">
      <a-input style="text-align: center" placeholder="USDT-RYUDE"></a-input>
    </a-form-item>
    <a-form-item  label="虚拟币网络">
      <a-input  style="text-align: center" placeholder="请输入主播提供的虚拟币网络"></a-input>
    </a-form-item>
    <a-form-item  label="提现地址">
      <a-input  style="text-align: center" placeholder="请输入主播提供的虚拟币提现地址"></a-input>
    </a-form-item>
